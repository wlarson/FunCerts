...
class TaggingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tagging" do
    assert_difference('Tagging.count') do
      post taggings_url, params: { tagging: { article_id: @tagging.article_id, tag_id: @tagging.tag_id } }
    end
  ...
  test "should update tagging" do
    patch tagging_url(@tagging), params: { tagging: { article_id: @tagging.article_id, tag_id: @tagging.tag_id } }
